                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Jumlah Peserta Sertifikasi</div>
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php
                                                    $data_peserta = mysqli_query($kon,"SELECT * FROM tbl_peserta");

                                                    // menghitung data barang
                                                    $jmlh_peserta= mysqli_num_rows($data_peserta);
                                                    ?>
                                                    
                                                    <p><?php echo  $jmlh_peserta;  ?></b></p>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                ...
                                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php
                                                    $data_admin = mysqli_query($kon,"SELECT * FROM tbl_users");

                                                    // menghitung data barang
                                                    $jmlh_admin= mysqli_num_rows($data_admin);
                                                    ?>
                                                    
                                                    <p><?php echo  $jmlh_admin;  ?></b></p>
